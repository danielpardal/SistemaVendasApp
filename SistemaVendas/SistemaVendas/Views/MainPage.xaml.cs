            ...
            if (!MenuPages.ContainsKey(id))
            {
                switch (id)
                {
                    case(int)MenuItemType.Inicio:
                        ...
                        break;
                    case (int)MenuItemType.Empresa:
                        MenuPages.Add(id, new NavigationPage(new EmpresaPage()));
                        break;
                    case (int)MenuItemType.Vendas:
                        MenuPages.Add(id, new NavigationPage(new VendasPage()));
                        break;
